...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFwdHl2aXZlayIsImEiOiJja3FyeWQyaWwxbGI3MnVtaDBlZ3QxcDJuIn0.96kSj7yYkizjBQGYMDuX-w';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description)).addTo(map); //extend map bound to include current location
...
var updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    var updateWhat, result;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            updateWhat = type === 'password' ? 'updateMyPassword' : 'updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/v1/users/".concat(updateWhat),
              data: data
            });
          ...
          case 4:
            ...
            if (result.data.status === 'success') {
              (0, _alert.showAlert)('success', "Your ".concat(type === 'password' ? 'password' : 'data', " updated successfully"));
              setTimeout(function () {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            if (_context.t0.response.data.status === 'error') (0, _alert.showAlert)('error', 'Something went wrong. Try Again!');
...
var stripe = Stripe('pk_test_51JCJ5nSBUWEqSq6TfKBVUmp7Be2cMcPJsNRF83HkZBESaK93gmejTuaOabZxjAMNzAIfmZ5GHPF1GUjIRMpFaIGs00Avm6jF8c');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            _context.t0 = _context["catch"](0);
            // console.log(err);
            (0, _alert.showAlert)('error', "Can't checkout now! Please try again later");
...
var bookEl = document.querySelector('#book-tour'); //VALUES
//DELEGATION
...
if (updateForm) {
  updateForm.addEventListener('submit', function (e) {
    ...
    form.append('photo', document.querySelector('#photo').files[0]); // updateSettings({ name, email }, 'data');
